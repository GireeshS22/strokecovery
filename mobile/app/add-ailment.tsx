...
import { ailmentApi } from '../services/api';
...
export default function AddAilmentScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Ailment logged!', [
        { text: 'OK', onPress: () => router.back() },
      ]);
    } catch (error: any) {
      Alert.alert('Error', error.message || 'Failed to log ailment');
    } finally {
      setIsLoading(false);
    }
  };

  const selectedSymptom = SYMPTOM_OPTIONS.find((s) => s.id === symptom);
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Log Ailment</Text>
        <Text style={styles.subtitle}>Track symptoms and discomfort</Text>
      </View>
      ...
      >
        {isLoading ? (
          ...
          <Text style={styles.saveButtonText}>Log Ailment</Text>
        )}
      </TouchableOpacity>
